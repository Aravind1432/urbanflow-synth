...
export function SceneSidebar({
  ...
  return (
    <div
      ...
      style={{ background: 'var(--cr-panel, #0A0A14)', borderRight: '1px solid rgba(124,58,237,0.1)', width: displayWidth, transition: isDraggingRef.current ? 'none' : 'width 0.3s ease' }}
    >
    >
      {/* Drag handle */}
      {!collapsed && (
      ...
      <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
        ...
        <div className="h-10 flex items-center justify-between shrink-0 relative mt-3 mb-1 px-3">
          ...
          >
            <img src="/askjai_hero.png" alt="AskJai" className="h-6" />
          </button>
          <button
